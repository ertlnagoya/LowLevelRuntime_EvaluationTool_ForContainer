...
* このツール本体(LowLevelRuntime_Evaluation_Tool_For_Container)は[MITライセンス](https://github.com/ertlnagoya/LowLevelRuntime_Evaluation_Tool_For_Container/blob/master/LICENSE)で公開されています。  
